    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="{{ route('admin.card.create')}}" class="btn btn-success mt-3"> <i class="bi bi-plus-circle"></i> New</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                                <tr>
                                    ...
                                    <td>{{$item->desc10}}</td>
                                    <td>
                                        <a href="{{ route('admin.card.edit', $item->id)}}" class="btn btn-warning"><i class="bi bi-pencil-square inline"></i></a>
                                        <form action="{{ route('admin.card.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
