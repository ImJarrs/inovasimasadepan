  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-7 order-1 order-lg-1 content">
        ...
        <img src="{{asset('assets/img/logo-recom.png')}}" class="img-fluid mb-4" alt="" width="140px">
      ...
      <div class="col-lg-12 order-3 card-list">
        ...
        <div class="row">
          ...
          <div class="col col-md-3">
            <div class="card">
              <i><x-fluentui-cloud-flow-24-o style="height: 50px; width: 50px;"/></i>
              <div class="card-body">
          ...
          <div class="col col-md-3">
            <div class="card">
              <i><x-tabler-wash-press style="height: 50px; width: 50px;" /></i>
              <div class="card-body">
          ...
          <div class="col col-md-3">
            <div class="card">
             <i><x-mdi-timer-sync-outline style="height: 50px; width: 50px;" /></i>
              <div class="card-body">
          ...
          <div class="col col-md-3">
            <div class="card">
              <i><x-tabler-timezone style="height: 50px; width: 50px;" /></i>
              <div class="card-body">
          ...
          <div class="col">
            <div class="card">
              <i><x-simpleline-info style="height: 50px; width: 50px;" /></i>
              <div class="card-body">
          ...
          <div class="col">
            <div class="card">
              <i><x-fluentui-apps-list-detail-20 style="height: 50px; width: 50px;" /></i>
              <div class="card-body">
          ...
          <div class="col">
            <div class="card">
              <i><x-fluentui-book-pulse-24 style="height: 50px; width: 50px;" /></i>
              <div class="card-body">
