...
<header id="header" class="header d-flex align-items-center fixed-top">
  ...
  <section id="about" class="about section m-0">
    <div class="about-image" aria-hidden="true">
      <img src="<?php echo e(asset('assets/img/about.webp')); ?>" alt="">
    </div>
  ...
  <section id="vision" class="vision section">
    <div class="container vision-layout">
      ...
      <div class="vision-hero-image">
        <img src="<?php echo e(asset('assets/img/visimisi.webp')); ?>" alt="IMD technology vision">
      </div>
...
<?php echo $__env->make('layouts.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\inovasimasadepan\imd\resources\views\index.blade.php ENDPATH**/ ?>